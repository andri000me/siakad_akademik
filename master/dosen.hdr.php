...
function TampilkanFilterDosen($mnux='dosen', $add=1) {
  ...
  echo "<script>window.location='?mnux=master/dosen&gos=DsnEdt&dsnid=$_SESSION[_Login]';</script>";
  }
...
function DaftarDosen($mnux='', $lnk='', $fields='') {
  ...
  if ($_SESSION['_LevelID']==100) {
  echo "Klik pada gambar <img src='img/edit.png' border=0> untuk mengedit detail data Dosen";
  }
  else {
