...
{	$NomerSurat = GetaField('pmb', "PMBID='$pmb[PMBID]' and KodeID", KodeID, 'NomerSurat');
	...
	$db_data[] = array('Isi'=>'<b>Perihal    : Mahasiswa Baru</b>');
	$db_data[] = array('Isi'=>'');
	...
	$db_data[] = array('Isi'=>'');
	$db_data[] = array('Isi'=>"Dengan ini kami sampaikan bahwa berdasarkan Hasil Seleksi Ujian masuk Tahun Ajaran / Akademik $tahun/$tahunnext ".$identitas[Nama]." pada tanggal ".GetDateInWords($gelombang['WawancaraSelesai']).", maka saudara yang namanya tersebut di atas dinyatakan :"); 
	$db_data[] = array('Isi'=>'');
	$db_data[] = array('Isi'=>'                                                                            <b>LULUS</b>');
	$db_data[] = array('Isi'=>'');
	$db_data[] = array('Isi'=>'Selanjutnya saudara/i diberikan kesempatan belajar di '.$identitas['Nama'].' dan diharapkan untuk:');
	$db_data[] = array('Isi'=>"   a. Memantau KRS (Kartu Rencana Studi) Semester I $tahun/$tahunnext di Portal ".$identitas['Nama'].". KRS akan diisi oleh Operator.");
	$db_data[] = array('Isi'=>"   b. Bahan PKKMB dapat diambil mulai tanggal ".TanggalFormat($gelombang['BahanPKKMBMulai'])." s/d ".TanggalFormat($gelombang['BahanPKKMBSelesai'])." di Kampus ".$identitas['Nama']." Jam 08.00 s.d 15.00 WIB");
	$db_data[] = array('Isi'=>'');
	$db_data[] = array('Isi'=>'');
	$db_data[] = array('Isi'=>'Akun Portal Anda:');
	$db_data[] = array('Isi'=>'   Username: '.$pmb['MhswID']);
	$db_data[] = array('Isi'=>'   Password: '.$pmb['TanggalLahir']);
	$db_data[] = array('Isi'=>'Silakan dipakai untuk login melalui alamat URL http://portal.unespadang.ac.id');
	$db_data[] = array('Isi'=>'');
	$db_data[] = array('Isi'=>'');
	$db_data[] = array('Isi'=>'Bila memerlukan informasi dan pelayanan akademik dapat menghubungi :');
	$db_data[] = array('Isi'=>'<b>Telp '.$identitas[Telepon].'</b> atau http://help.unespadang.ac.id');
	$db_data[] = array('Isi'=>'');
	...
	$db_data[] = array('Isi'=>"<b>...</b>");
	$db_data[] = array('Isi'=>'Panitia Penerimaan Mahasiswa Baru');
