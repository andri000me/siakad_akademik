	...
	*/
	...
	include_once "../dwo.lib.php";
  	...
  	include_once "../cekparam.php";
  		$TAID = ($_SESSION['_LevelID']!='120' ? GetSetVar('MhswID'): $_SESSION['_Login']);
		$MhswID = GetaField("ta", "MhswID", $TAID, "MhswID");
		//echo $TAID;
		if($ta = GetFields("ta", "NA='N' AND MhswID", $MhswID, "*"))
		{
			...
			$rowpenguji1 	= GetaField('dosen', "NA='N' AND Login", $ta['PengujiProposal'], "concat(Gelar1,' ',Nama, ', ', Gelar)");
			$rowpenguji2 	= GetaField('tadosen t left outer join dosen d on d.Login=t.DosenID', "t.Tipe=2 and t.TAID", $ta['TAID'], "concat(d.Gelar1,' ',d.Nama, ', ', d.Gelar)");
			...
			echo "<html><head><title>SK Penunjukan Penguji Seminar Proposal ".($Data['FID']=='08'? "Tesis":"TA/Skripsi")." ".$Data['Nama']." - NPM ".$Data['MhswID']."</title>";
			echo "<style>
			body {
				margin-left: 0 px;
			...
			<tr>
			<td width='10%' class='alamat' style='text-align:left;' valign='top'><img src='../img/ubh_logo.png' width='50' border='0' alt='Cetak Bukti' title='Cetak Bukti'></td>
			...
			PENUNJUKAN PEMBIMBING TIM PENGUJI UJIAN SEMINAR PROPOSAL<br />
			...
			<td width='77%' valign='top' style='text-align:Justify'>bahwa untuk pelaksanaan ujian seminar proposal Mahasiswa ".($Data['FID']=='08'? "Program":"Fakultas")." ".ucwords(strtolower($Data['Fakultas']))." ".ucwords(strtolower($NamaPT))." perlu ditunjuk tim penguji;</td>
			</tr>
			<tr>
			...
			<td valign='top'>:</td>
			<td valign='top' style='text-align:Justify'>Menunjuk dan menetapkan nama-nama dosen tim penguji ujian seminar proposal Program Studi ".$Data['Jurusan']." ".($Data['FID']=='08'? "Program":"Fakultas")." ".ucwords(strtolower($Data['Fakultas']))." ".ucwords(strtolower($NamaPT))." bagi mahasiswa:<br /></td>
			</tr>
			<tr>
			<td valign='top'>&nbsp;</td>
			<td valign='top'>&nbsp;</td>
			...
			<table style='width:95%'>
			<tr>
			<td width='25%'>Ketua Penguji</td>
			<td width='3%'>:</td>
			<td width='70%'><b>".$rowpemb1."</b></td>
			</tr>
			<tr>
			<td width='25%'>Sekretaris Penguji</td>
			<td width='3%'>:</td>
			<td width='70%'><b>".$rowpemb2."</b></td>
			</tr>
			<td width='25%'>Anggota</td>
			<td width='3%'>:</td>
			<td width='70%'><b>".$rowpenguji1."</b></td>
			</tr>
			<tr>
			<td width='25%'>Anggota</td>
			<td width='3%'>:</td>
			<td width='70%'><b>".$rowpenguji2."</b></td>
			</tr>
			...
			<ol>
			<li>Melaksanakan ujian seminar proposal sesuai disiplin ilmu yang terkait.
			...
			<li>Membuat Berita Acara tentang ujian seminar proposal mahasiswa yang bersangkutan.
			</ol>
			</td>
			</tr>
