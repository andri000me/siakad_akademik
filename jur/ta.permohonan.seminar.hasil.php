	...
	$Jabatan = GetSetVar('Jabatan');
		if($ta = GetFields("ta", "MhswID", $MhswID, "*"))
		{
			...
			$Identitas		= GetFields('identitas',"Kode",KodeID,'*');
					...
					echo "<html>
					<head>
					<title>Surat Permohonan Seminar Hasil ".$Data['Nama']." (NPM ".$Data['MhswID'].")</title>
					<style>
					body {
						margin-left: 0 px;
					...
					<td valign='top'>:</td>
					<td><b><i>Permohonan seminar hasil</i></b>
					</td>
					...
					<tr>
					<td colspan='4' style='text-align:Justify'>Dengan ini mengajukan permohonan untuk melaksanakan seminar hasil :</td>
					</tr>
					...
					<tr>
					<td colspan='4' style='text-align:Justify'>Sebagai bahan pertimbangan penetapan Surat Keputusan (SK) pelaksanaan Seminar Hasil, saya lampirkan:
					<br>
					<ol>
					<li>Tanda persetujuan seminar hasil dari pembimbing</li>
					<li>Foto kopi Lembar Hasil Studi (LHS) semester sebelumnya</li>
					<li>Foto kopi draft hasil/".($Data['FID']=='08'? "tesis":"skripsi/TA")." 1 (satu) rangkap dan dalam bentuk softcopy (CD)</li>
					</ol>
					</td>
					</tr>
