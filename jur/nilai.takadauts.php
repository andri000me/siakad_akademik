...
// *** Init PDF
$pdf = new FPDF();
$pdf->SetTitle("Daftar Dosen Yang Belum Entry Nilai UTS");
...
HeaderLogo("Dosen yang Belum Entry UTS $tahunstring", $pdf, 'P');
...
function BuatIsinya($TahunID, $ProdiID, $p) {
  ...
  if($_dosenid != $w['Login'])
	...
	$BelumIsi = GetaField('krs', "JadwalID='$w[JadwalID]' and UTS = 0 and KodeID", KodeID,  "count(KRSID)");
