...
$jutsid2 = $_REQUEST['jutsid2']+0;
$jutsid3 = $_REQUEST['jutsid3']+0;
$jutsid4 = $_REQUEST['jutsid4']+0;
$jutsid5 = $_REQUEST['jutsid5']+0;

// *** Main ***
$gos = (empty($_REQUEST['gos']))? 'Edit' : $_REQUEST['gos'];
$gos($md, $id, $jutsid, $jutsid2,$jutsid3, $jutsid4,$jutsid5);

// *** Functions ***
function Edit($md, $id, $jutsid, $jutsid2,$jutsid3, $jutsid4,$jutsid5) {
  ...
  if ($md == 0) {
	...
	$jadwaluts2 = GetFields('jadwaluts', 'JadwalUTSID', $jutsid2, '*');
    $jadwaluts3 = GetFields('jadwaluts', 'JadwalUTSID', $jutsid3, '*');
	$jadwaluts4 = GetFields('jadwaluts', 'JadwalUTSID', $jutsid4, '*');
    $jadwaluts5 = GetFields('jadwaluts', 'JadwalUTSID', $jutsid5, '*');
	...
	$w0['UTSDosenID'] = $jadwaluts2['DosenID'];
	$w0['UTSRuangID'] = $jadwaluts2['RuangID'];
	$w0['UTSKapasitas'] = $jadwaluts2['Kapasitas'];
	$w0['UTSKolomUjian'] = $jadwaluts2['KolomUjian'];
	$w0['UTSDosen'] = GetaField('dosen', "Login='$jadwaluts2[DosenID]' and KodeID", KodeID, 'Nama');
    
    $w3['UTSDosenID'] = $jadwaluts3['DosenID'];
	$w3['UTSRuangID'] = $jadwaluts3['RuangID'];
	$w3['UTSKapasitas'] = $jadwaluts3['Kapasitas'];
	$w3['UTSKolomUjian'] = $jadwaluts3['KolomUjian'];
	$w3['UTSDosen'] = GetaField('dosen', "Login='$jadwaluts3[DosenID]' and KodeID", KodeID, 'Nama');
    
    $w4['UTSDosenID'] = $jadwaluts4['DosenID'];
	$w4['UTSRuangID'] = $jadwaluts4['RuangID'];
	$w4['UTSKapasitas'] = $jadwaluts4['Kapasitas'];
	$w4['UTSKolomUjian'] = $jadwaluts4['KolomUjian'];
	$w4['UTSDosen'] = GetaField('dosen', "Login='$jadwaluts4[DosenID]' and KodeID", KodeID, 'Nama');
    
    $w5['UTSDosenID'] = $jadwaluts5['DosenID'];
	$w5['UTSRuangID'] = $jadwaluts5['RuangID'];
	$w5['UTSKapasitas'] = $jadwaluts5['Kapasitas'];
	$w5['UTSKolomUjian'] = $jadwaluts5['KolomUjian'];
	$w5['UTSDosen'] = GetaField('dosen', "Login='$jadwaluts5[DosenID]' and KodeID", KodeID, 'Nama');
  }
  elseif ($md == 1) {
...
function GetDateOption3($value,$name){
  ...
  //$opttgluas = GetDateOption3($w['UTSTanggal'], 'UTSTanggal');  
  $opttgluas = GetDateOption($w['UTSTanggal'], 'UTSTanggal');
  
  // Fungsi melihat jam ujian, bagi prodi yang ada mengatur ini ditampilkan berupa 1 combobox saja
  $jmu = _query("SELECT * from jamujian where ProdiID='$_SESSION[_utsProdi]'");
  	$optJam = '';
  ...
  $optJamMulai = "<select name='UTSJamMulai_h' onchange=\"javascript:setJamSelesai(this)\">$_hr</select>
    <select name='UTSJamMulai_n'>$_mn</select>";
...
echo '
  <script>
  	function setJamSelesai(jam){
		...
		if (jamnya == "08"){
		frmJadwalUTS.UTSJamSelesai_h.value="09";
		frmJadwalUTS.UTSJamSelesai_n.value="30";
		}
		else if (jamnya == "10"){
		frmJadwalUTS.UTSJamSelesai_h.value="11";
		frmJadwalUTS.UTSJamSelesai_n.value="30";
		}
		else if (jamnya == "13"){
		frmJadwalUTS.UTSJamSelesai_h.value="14";
		frmJadwalUTS.UTSJamSelesai_n.value="30";
		}
		else if (jamnya == "15"){
		frmJadwalUTS.UTSJamSelesai_h.value="16";
		frmJadwalUTS.UTSJamSelesai_n.value="30";
		}
		else if (jamnya == "14"){
		frmJadwalUTS.UTSJamSelesai_h.value="15";
		frmJadwalUTS.UTSJamSelesai_n.value="30";
		}
		else if (jamnya == "16"){
		frmJadwalUTS.UTSJamSelesai_h.value="17";
		frmJadwalUTS.UTSJamSelesai_n.value="30";
		}
	}
  	function cekJdwl(){
...
<tr><td colspan="4"><hr noshade="noshade" style="color:#CCCCCC" /></td></tr>
  <tr><td class=inp>Ruang UTS 1:</td>
      <td class=ul1>
      ...
      <td class=ul1>
		...
		<input type=hidden name='UTSKapasitasH' value='$w[UTSKapasitas]' size=4 maxlength=5 />
        <sub>orang</sub>
        </td>
      </tr>
  <tr><td class=inp>Kolom Ujian:</td>
	  ...
	  <td class=ul1><input type=text name='UTSBarisUjian' value='$w[UTSBarisUjian]' size=1 maxlength=2  />
  </tr>
...
END;
  ...
  <tr><td class=inp>Ruang UTS 2:</td>
      <td class=ul1>
        <input type=text name='UTSRuangID2' value='$w0[UTSRuangID]' size=10 maxlength=50 
          onKeyUp="javascript:CariRuang('$_SESSION[_utsProdi]', 'frmJadwalUTS', '', '2')" />
        &raquo;
      <a href='#'
        onClick="javascript:CariRuang('$_SESSION[_utsProdi]', 'frmJadwalUTS', '', '2')" />Cari...</a> |
      <a href='#' onClick="javascript:frmJadwalUTS.UTSRuangID2.value=''">Reset</a> <sub> *) Kosongkan jika memakai 1 ruang saja</sub>
        </td>
      <td class=inp>Kapasitas:</td>
      <td class=ul1>
        <input type=text name='UTSKapasitas2' value='$w0[UTSKapasitas]' size=4 maxlength=5 />
		<input type=hidden name='UTSKapasitasH2' value='$w0[UTSKapasitas]' size=4 maxlength=5 />
        <sub>orang</sub>
        </td>
      </tr>
  <tr><td class=inp>Kolom Ujian:</td>
	  <td class=ul1><input type=text name='UTSKolomUjian2' value='$w0[UTSKolomUjian]' onChange="HitungBaris('frmJadwalUTS')" size=1 maxlength=2 />
	  <td class=inp>Baris Ujian:</td>
	  <td class=ul1><input type=text name='UTSBarisUjian2' value='$w0[UTSBarisUjian]' size=1 maxlength=2  />
  </tr>
  
  <tr><td class=inp>Dosen Pengawas:</td>
      <td class=ul1 colspan=3 nowrap>
      <input type=text name='UTSDosenID2' value='$w0[UTSDosenID]' size=10 maxlength=50 />
      <input type=text name='UTSDosen2' value='$w0[UTSDosen]' size=30 maxlength=50 onKeyUp="javascript:CariDosen('$_SESSION[_utsProdi]', 'frmJadwalUTS', '2')" />
      <div style='text-align:right'>
      &raquo;
      <a href='#'
        onClick="javascript:CariDosen('$_SESSION[_utsProdi]', 'frmJadwalUTS','2')" />Cari...</a> |
...
echo <<<END3
  <tr><td class=inp>Ruang UTS 3:</td>
      <td class=ul1>
        <input type=text name='UTSRuangID3' value='$w3[UTSRuangID]' size=10 maxlength=50 
          onKeyUp="javascript:CariRuang('$_SESSION[_utsProdi]', 'frmJadwalUTS', '', '3')" />
        &raquo;
      <a href='#'
        onClick="javascript:CariRuang('$_SESSION[_utsProdi]', 'frmJadwalUTS', '', '3')" />Cari...</a> |
      <a href='#' onClick="javascript:frmJadwalUTS.UTSRuangID3.value=''">Reset</a> 
        </td>
      <td class=inp>Kapasitas:</td>
      <td class=ul1>
        <input type=text name='UTSKapasitas3' value='$w3[UTSKapasitas]' size=4 maxlength=5 />
		<input type=hidden name='UTSKapasitasH3' value='$w3[UTSKapasitas]' size=4 maxlength=5 />
        <sub>orang</sub>
        </td>
      </tr>
  <tr><td class=inp>Kolom Ujian:</td>
	  <td class=ul1><input type=text name='UTSKolomUjian3' value='$w3[UTSKolomUjian]' onChange="HitungBaris('frmJadwalUTS')" size=1 maxlength=2 />
	  <td class=inp>Baris Ujian:</td>
	  <td class=ul1><input type=text name='UTSBarisUjian3' value='$w3[UTSBarisUjian]' size=1 maxlength=2  />
  </tr>
  
  <tr><td class=inp>Dosen Pengawas:</td>
      <td class=ul1 colspan=3 nowrap>
      <input type=text name='UTSDosenID3' value='$w3[UTSDosenID]' size=10 maxlength=50 />
      <input type=text name='UTSDosen3' value='$w3[UTSDosen]' size=30 maxlength=50 onKeyUp="javascript:CariDosen('$_SESSION[_utsProdi]', 'frmJadwalUTS', '3')" />
      <div style='text-align:right'>
      &raquo;
      <a href='#'
        onClick="javascript:CariDosen('$_SESSION[_utsProdi]', 'frmJadwalUTS','3')" />Cari...</a> |
      <a href='#' onClick="javascript:frmJadwalUTS.UTSDosenID3.value='';frmJadwalUTS.UTSDosen3.value=''">Reset</a>
      </div>
      </td>
      </tr>
      <tr><td colspan="4"><hr noshade="noshade" style="color:#CCCCCC" /></td></tr>
...
//echo <<<END4
//  <tr><td class=inp>Ruang UTS 4:</td>
//      <td class=ul1>
//        <input type=text name='UTSRuangID4' value='$w4[UTSRuangID]' size=10 maxlength=50 
//          onKeyUp="javascript:CariRuang('$_SESSION[_utsProdi]', 'frmJadwalUTS', '', '4')" />
//        &raquo;
//      <a href='#'
//        onClick="javascript:CariRuang('$_SESSION[_utsProdi]', 'frmJadwalUTS', '', '4')" />Cari...</a> |
//      <a href='#' onClick="javascript:frmJadwalUTS.UTSRuangID4.value=''">Reset</a> 
//        </td>
//      <td class=inp>Kapasitas:</td>
//      <td class=ul1>
//        <input type=text name='UTSKapasitas4' value='$w4[UTSKapasitas]' size=4 maxlength=5 />
//		<input type=hidden name='UTSKapasitasH4' value='$w4[UTSKapasitas]' size=4 maxlength=5 />
//        <sub>orang</sub>
//        </td>
//      </tr>
//  <tr><td class=inp>Kolom Ujian:</td>
//	  <td class=ul1><input type=text name='UTSKolomUjian4' value='$w4[UTSKolomUjian]' onChange="HitungBaris('frmJadwalUTS')" size=1 maxlength=2 />
//	  <td class=inp>Baris Ujian:</td>
//	  <td class=ul1><input type=text name='UTSBarisUjian4' value='$w4[UTSBarisUjian]' size=1 maxlength=2  />
//  </tr>
//  
//  <tr><td class=inp>Dosen Pengawas:</td>
//      <td class=ul1 colspan=3 nowrap>
//      <input type=text name='UTSDosenID4' value='$w4[UTSDosenID]' size=10 maxlength=50 />
//      <input type=text name='UTSDosen4' value='$w4[UTSDosen]' size=30 maxlength=50 onKeyUp="javascript:CariDosen('$_SESSION[_utsProdi]', 'frmJadwalUTS', '4')" />
//      <div style='text-align:right'>
//      &raquo;
//      <a href='#'
//        onClick="javascript:CariDosen('$_SESSION[_utsProdi]', 'frmJadwalUTS','4')" />Cari...</a> |
//      <a href='#' onClick="javascript:frmJadwalUTS.UTSDosenID4.value='';frmJadwalUTS.UTSDosen4.value=''">Reset</a>
//      </div>
//      </td>
//      </tr>
//      <tr><td colspan="4"><hr noshade="noshade" style="color:#CCCCCC" /></td></tr>
...
//
//echo <<<END5
//  <tr><td class=inp>Ruang UTS 5:</td>
//      <td class=ul1>
//        <input type=text name='UTSRuangID5' value='$w5[UTSRuangID]' size=10 maxlength=50 
//          onKeyUp="javascript:CariRuang('$_SESSION[_utsProdi]', 'frmJadwalUTS', '', '5')" />
//        &raquo;
//      <a href='#'
//        onClick="javascript:CariRuang('$_SESSION[_utsProdi]', 'frmJadwalUTS', '', '5')" />Cari...</a> |
//      <a href='#' onClick="javascript:frmJadwalUTS.UTSRuangID5.value=''">Reset</a> 
//        </td>
//      <td class=inp>Kapasitas:</td>
//      <td class=ul1>
//        <input type=text name='UTSKapasitas5' value='$w5[UTSKapasitas]' size=4 maxlength=5 />
//		<input type=hidden name='UTSKapasitasH5' value='$w5[UTSKapasitas]' size=4 maxlength=5 />
//        <sub>orang</sub>
//        </td>
//      </tr>
//  <tr><td class=inp>Kolom Ujian:</td>
//	  <td class=ul1><input type=text name='UTSKolomUjian5' value='$w5[UTSKolomUjian]' onChange="HitungBaris('frmJadwalUTS')" size=1 maxlength=2 />
//	  <td class=inp>Baris Ujian:</td>
//	  <td class=ul1><input type=text name='UTSBarisUjian5' value='$w5[UTSBarisUjian]' size=1 maxlength=2  />
//  </tr> 
//  
//  <tr><td class=inp>Dosen Pengawas:</td>
//      <td class=ul1 colspan=3 nowrap>
//      <input type=text name='UTSDosenID5' value='$w5[UTSDosenID]' size=10 maxlength=50 />
//      <input type=text name='UTSDosen5' value='$w5[UTSDosen]' size=30 maxlength=50 onKeyUp="javascript:CariDosen('$_SESSION[_utsProdi]', 'frmJadwalUTS', '5')" />
//      <div style='text-align:right'>
//      &raquo;
//      <a href='#'
//        onClick="javascript:CariDosen('$_SESSION[_utsProdi]', 'frmJadwalUTS','5')" />Cari...</a> |
//      <a href='#' onClick="javascript:frmJadwalUTS.UTSDosenID5.value='';frmJadwalUTS.UTSDosen5.value=''">Reset</a>
//      </div>
//      </td>
//      </tr>
//      <tr><td colspan="4"><hr noshade="noshade" style="color:#CCCCCC" /></td></tr>
...
function Simpan($md, $id, $jutsid) {
  ...
  if (!empty($_REQUEST['JamUjian'])) {
  	$JJ = GetFields('jamujian', "JamUjianID='$_REQUEST[JamUjian]' AND ProdiID", $_SESSION['_utsProdi'], "left(JamMulai,5) as JamMulai, left(JamSelesai,5) as JamSelesai");
    
    $w['UTSJamMulai'] = "$JJ[JamMulai]";
  	$w['UTSJamSelesai'] = "$JJ[JamSelesai]";
  }
  else {
  ...
  $w['UTSRuangID3'] = $_REQUEST['UTSRuangID3'];
  $w['UTSKapasitas3'] = $_REQUEST['UTSKapasitas3'];
  $w['UTSKolomUjian3'] = $_REQUEST['UTSKolomUjian3'];
  $w['UTSDosenID3'] = $_REQUEST['UTSDosenID3'];

  $w['UTSRuangID4'] = $_REQUEST['UTSRuangID4'];
  $w['UTSKapasitas4'] = $_REQUEST['UTSKapasitas4'];
  $w['UTSKolomUjian4'] = $_REQUEST['UTSKolomUjian4'];
  $w['UTSDosenID4'] = $_REQUEST['UTSDosenID4'];
  
  $w['UTSRuangID5'] = $_REQUEST['UTSRuangID5'];
  $w['UTSKapasitas5'] = $_REQUEST['UTSKapasitas5'];
  $w['UTSKolomUjian5'] = $_REQUEST['UTSKolomUjian5'];
  $w['UTSDosenID5'] = $_REQUEST['UTSDosenID5'];
  ...
  if (empty($oke)) {
    ...
    if ($md == 0) {
      ...
      $r = _query($s);
	   $s3 = "delete from utsmhsw
        where JadwalUTSID = '$jutsid' ";
      $r3 = _query($s3);
	  DaftarkanMhswKeRuangUTS($w, $jutsid);
	  }
	  if (!empty($w[UTSRuangID2])) 
	  {
	  if (empty($jutsid2)) {
	  ...
	  DaftarkanMhswKeRuangUTS2($w, $JadwalUTSID2);
	  }
	  else {
	  $s2 = "update jadwaluts
        set RuangID = '$w[UTSRuangID2]',
			DosenID = '$w[UTSDosenID2]',
            Tanggal = '$w[UTSTanggal]',
			Kapasitas = '$w[UTSKapasitas2]',
            JamMulai = '$w[UTSJamMulai]', JamSelesai = '$w[UTSJamSelesai]',
			KolomUjian = '$w[UTSKolomUjian2]',
			TanggalEdit = now(),
            LoginEdit = '$_SESSION[_Login]'
        where JadwalUTSID = '$jutsid2' ";
      $r2 = _query($s2);
	  
	   $s4 = "delete from utsmhsw
        where JadwalUTSID = '$jutsid2' ";
      $r4 = _query($s4);
	  DaftarkanMhswKeRuangUTS2($w, $jutsid2);
	  }
	  }
	...
	if ($w[UTSRuangID] !='') {
	  ...
	  DaftarkanMhswKeRuangUTS($w, $JadwalUTSID, '1');
	  }
	 if ($w[UTSRuangID2] !='') {
	  $s = "insert into jadwaluts
        (KodeID, TahunID, JadwalID, DosenID, 
	  ...
	  $JadwalUTSID = mysql_insert_id();
	  DaftarkanMhswKeRuangUTS($w, $JadwalUTSID,'2');
	  }
      if ($w[UTSRuangID3] !='') {
	  $s = "insert into jadwaluts
        (KodeID, TahunID, JadwalID, DosenID, 
		...
		Kapasitas, RuangID, KolomUjian, TanggalBuat, LoginBuat)
        values
        ('".KodeID."', '$w[TahunID]', '$w[JadwalID]', '$w[UTSDosenID3]',
        '$w[UTSTanggal]', '$w[UTSJamMulai]', '$w[UTSJamSelesai]',
		'$w[UTSKapasitas3]', '$w[UTSRuangID3]', '$w[UTSKolomUjian3]', now(), '$_SESSION[_Login]')";
      $r = _query($s);
	  
	  $JadwalUTSID = mysql_insert_id();
	  DaftarkanMhswKeRuangUTS($w, $JadwalUTSID,'3');
	  }
      if ($w[UTSRuangID4] !='') {
	  $s = "insert into jadwaluts
        (KodeID, TahunID, JadwalID, DosenID, 
		...
		Kapasitas, RuangID, KolomUjian, TanggalBuat, LoginBuat)
        values
        ('".KodeID."', '$w[TahunID]', '$w[JadwalID]', '$w[UTSDosenID4]',
        '$w[UTSTanggal]', '$w[UTSJamMulai]', '$w[UTSJamSelesai]',
		'$w[UTSKapasitas4]', '$w[UTSRuangID4]', '$w[UTSKolomUjian4]', now(), '$_SESSION[_Login]')";
      $r = _query($s);
	  
	  $JadwalUTSID = mysql_insert_id();
	  DaftarkanMhswKeRuangUTS($w, $JadwalUTSID,'4');
	  }
      if ($w[UTSRuangID5] !='') {
	  $s = "insert into jadwaluts
        (KodeID, TahunID, JadwalID, DosenID, 
		...
		Kapasitas, RuangID, KolomUjian, TanggalBuat, LoginBuat)
        values
        ('".KodeID."', '$w[TahunID]', '$w[JadwalID]', '$w[UTSDosenID5]',
        '$w[UTSTanggal]', '$w[UTSJamMulai]', '$w[UTSJamSelesai]',
		'$w[UTSKapasitas5]', '$w[UTSRuangID5]', '$w[UTSKolomUjian5]', now(), '$_SESSION[_Login]')";
      $r = _query($s);
	  
	  $JadwalUTSID = mysql_insert_id();
	  DaftarkanMhswKeRuangUTS($w, $JadwalUTSID,'5');
	  }
...
{ $uas = GetFields('tahun', "TahunID='$w[TahunID]' and ProgramID='$w[ProgramID]' and ProdiID='$w[ProdiID]' and KodeID", KodeID, "LEFT(TglUTSMulai, 10) as _TglUTSMulai, LEFT(TglUTSSelesai, 10) as _TglUTSSelesai");

  $a = '';
  if ($uas['_TglUTSMulai'] > $w['UTSTanggal'] or $w['UTSTanggal'] > $uas['_TglUTSSelesai'])
  {
    $a .= "<li>
      <b>Tanggal UTS ".$w[UTSTanggal]." berada di luar Tanggal UTS yang direncanakan</b>:<br />
		 Rentang waktu yang disediakan: ".$uas['_TglUTSMulai']." s/d ".$uas['_TglUTSSelesai']."<br />
      ";
  }
  return $a;
}
function DaftarkanMhswKeRuangUTS2($w, $JadwalUTSID2)
{	//echo "JADWALUTSID=$JadwalUTSID1 ,JADWALID=$w[JadwalID]<br>";
	if($JadwalUTSID2+0 != 0)
    {   $limit2= $w['UTSKapasitas2']+0;
		$batas = $w['UTSKapasitas']+0;
		$s4 = "select k.MhswID from krs k,khs h where khs h, krs k
    ...
    order by k.MhswID limit $batas, $limit2";
      ...
      $totByrMhs = GetaField("khs", "TahunID='$w4[TahunID]' And MhswID", $w4['MhswID'],'Bayar')+0;
...
function DaftarkanMhswKeRuangUTS($w, $JadwalUTSID1, $Ruang)
{	//echo "JADWALUTSID=$JadwalUTSID1 ,JADWALID=$w[JadwalID]<br>";
	if($JadwalUTSID1+0 != 0)
    {   
    	if ($Ruang == 1) { $start=0; $limit = $w['UTSKapasitas']+0; }
        if ($Ruang == 2) { $start=$w['UTSKapasitas']; $limit = $w['UTSKapasitas2']+0; }
        if ($Ruang == 3) { $start=$w['UTSKapasitas']+$w['UTSKapasitas2']; $limit = $w['UTSKapasitas3']+0; }
        if ($Ruang == 4) { $start=$w['UTSKapasitas']+$w['UTSKapasitas2']+$w['UTSKapasitas3']; $limit = $w['UTSKapasitas4']+0; }
        if ($Ruang == 5) { $start=$w['UTSKapasitas']+$w['UTSKapasitas2']+$w['UTSKapasitas3']+$w['UTSKapasitas4']; 
        					$limit = $w['UTSKapasitas5']+0; }
		
        $s6 = "select k.MhswID,m.StatusAwalID,k.MKKode,k.TahunID,h.Sesi from khs h, krs k
              left outer join mhsw m on m.MhswID = k.MhswID and m.KodeID = '".KodeID."'
              left outer join prodi p on p.ProdiID = m.ProdiID
            where k.JadwalID = '$w[JadwalID]'
            AND h.MhswID=k.MhswID
      ...
      {	$s1 = "insert into utsmhsw
        ...
        $JumlahMhsw = GetaField('utsmhsw', "JadwalUTSID='$JadwalUTSID1' and KodeID", KodeID, 'count(UTSMhswID)'); 
		$s = _query("update jadwaluts set JumlahMhsw = '$JumlahMhsw' where JadwalUTSID='$JadwalUTSID1'");
...
function JdwlUTSScript() {
  ...
  function CariRuang(ProdiID, frm, kapasitasR,Ke) {
    if (eval(frm + ".UTSRuangID" + Ke + ".value != ''")) {
      eval(frm + ".UTSRuangID" + Ke + ".focus()");
      showRuang(ProdiID, frm, eval(frm +".UTSRuangID" + Ke + ".value"), 'cariruang', kapasitasR, eval("frmJadwalUTS.UTSTanggal_y.value"),eval("frmJadwalUTS.UTSTanggal_m.value"),eval("frmJadwalUTS.UTSTanggal_d.value"),eval("frmJadwalUTS.UTSJamMulai_h.value"),eval("frmJadwalUTS.UTSJamMulai_n.value"), eval("frmJadwalUTS.UTSJamSelesai_h.value"),eval("frmJadwalUTS.UTSJamSelesai_n.value"), eval(frm +".TahunID.value"),Ke);
	...
	if (eval(frm + ".UTSRuangID2.value != ''")) {
      ...
      showRuang(ProdiID, frm, eval(frm +".UTSRuangID2.value"), 'cariruang', kapasitasR, eval(frm +".UTSTanggal_y.value"),eval(frm 		+".UTSTanggal_m.value"),eval(frm +".UTSTanggal_d.value"),eval(frm +".UTSJamMulai_h.value"),eval(frm +".UTSJamMulai_n.value"), eval(frm +".UTSJamSelesai_h.value"),eval(frm +".UTSJamSelesai_n.value"), eval(frm +".TahunID.value"));
      toggleBox('cariruang', 1);
    }
  }
  
  function CariDosen(ProdiID, frm, Ke) {
    if (eval(frm + ".UTSDosen" + Ke + ".value != ''")) {
      eval(frm + ".UTSDosen" + Ke + ".focus()");
      showDosen(ProdiID, frm, eval(frm + ".UTSDosen" + Ke + ".value"), 'caridosen', eval(frm +".UTSTanggal_y.value"),eval(frm 		+".UTSTanggal_m.value"),eval(frm +".UTSTanggal_d.value"),eval(frm +".UTSJamMulai_h.value"),eval(frm +".UTSJamMulai_n.value"), eval(frm +".UTSJamSelesai_h.value"),eval(frm +".UTSJamSelesai_n.value"), eval(frm +".TahunID.value"), Ke);
    ...
    if (eval(frm + ".UTSDosen2.value != ''")) {
      ...
      showDosen(ProdiID, frm, eval(frm +".UTSDosen2.value"), 'caridosen', eval(frm +".UTSTanggal_y.value"),eval(frm 		+".UTSTanggal_m.value"),eval(frm +".UTSTanggal_d.value"),eval(frm +".UTSJamMulai_h.value"),eval(frm +".UTSJamMulai_n.value"), eval(frm +".UTSJamSelesai_h.value"),eval(frm +".UTSJamSelesai_n.value"), eval(frm +".TahunID.value"));
      toggleBox('caridosen', 1);
    }
  }
