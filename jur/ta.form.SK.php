	...
	*/
	...
	include_once "../dwo.lib.php";
  	...
  	include_once "../cekparam.php";
  		$TAID = ($_SESSION['_LevelID']!='120' ? GetSetVar('TAID'): $_SESSION['_Login']);
		$MhswID = ($_SESSION['_LevelID']!='120' ? GetaField("ta", "TAID", $TAID, "MhswID") : GetaField("ta", "MhswID", $TAID, "MhswID"));
		...
		if($ta = GetFields("ta", "NA='N' AND MhswID", $MhswID, "*"))
		{
			...
			PENUNJUKAN PEMBIMBING PENELITIAN/TA<br />
			...
			<td width='77%' valign='top' style='text-align:Justify'>bahwa untuk kelancaran pelaksanaan penelitian/TA bagi mahasiswa;</td>
			</tr>
			<tr>
