	...
	while ($w9 = _fetch_array($r8)) {
		...
		if (($w9['JmlDosen']>0) and ($w9['JmlDosen']<3))
		{
			...
			if ($w['NA'] == 'Y') {
			  ...
			  $d = "<font color=yellow>
			  <a href=\"javascript:$_SESSION[frm].UASDosenID$_SESSION[UR].value='$w[Login]'; $_SESSION[frm].UASDosen$_SESSION[UR].value='$w[Nama]';toggleBox('$_SESSION[div]', 0)\">
				Pilih</a></font>
				";
