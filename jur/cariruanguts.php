...
function TampilkanDaftar() {
  ...
  while ($w = _fetch_array($r)) {
    ...
    from jadwal jd, kelas kl, utsmhsw u, jadwaluts j
	  where 
      j.RuangID = '$w[RuangID]'
	  ...
	  and u.JadwalUTSID=j.JadwalUTSID and jd.JadwalID=j.JadwalID and kl.KelasID=jd.NamaKelas
      ";
	$r8 = _query($s8);
	...
	if ($KapasitasUjian>0) {
      ...
      <td class=ul1>
        ...
        <a href="javascript:$_SESSION[frm].UTSRuangID$_SESSION[UR].value='$w[RuangID]'; $_SESSION[frm].UTSKapasitas$_SESSION[UR].value='$KapasitasUjian'; $_SESSION[frm].UTSKolomUjian$_SESSION[UR].value='$w[KolomUjian]'; $_SESSION[frm].UTSBarisUjian$_SESSION[UR].value='$w[BarisUjian]'; toggleBox('$_SESSION[div]', 0)"> &raquo;Pilih</a>
      </td>
