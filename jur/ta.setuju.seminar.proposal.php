	...
	$MhswID = ($_SESSION['_LevelID']!='120' ? GetSetVar('MhswID'): $_SESSION['_Login']);
		if($ta = GetFields("ta", "MhswID", $MhswID, "*"))
		{
			...
			$Identitas		= GetFields('identitas',"Kode",KodeID,'*');
					...
					echo "<html>
					<head>
					<title>Tanda Persetujuan Seminar Proposal ".$Data['Nama']." (NPM ".$Data['MhswID'].")</title>
					<style>
					body {
						margin-left: 0 px;
					...
					<tr>
					<td colspan='4'><h3 align=center>TANDA PERSETUJUAN SEMINAR PROPOSAL</td>
					</tr>";
					...
					<tr>
					<td colspan='4'>Kami yang bertanda tangan di bawah ini adalah Pembimbing Seminar Proposal dari :</td>
					</tr>
					...
					<tr>
					<td colspan='4' style='text-align:Justify'>Dengan ini menyatakan telah menyetujui proposal mahasiswa tersebut untuk diseminarkan pada ".($Data['FID']=='08'? "Program":"Fakultas")." ".$Data['Fakultas']." ".$Identitas['Nama'].".</td>
					</tr>
