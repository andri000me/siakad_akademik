	...
	include_once "../dwo.lib.php";
  	...
  	include_once "../cekparam.php";
		...
		if($ta = GetFields("ta", "NA='N' AND MhswID", $MhswID, "*"))
		{
			...
			echo "<html><head><title>SK Penunjukan Pembimbing ".($Data['FID']=='08'? "Tesis":"TA/Skripsi")." ".$Data['Nama']." - NPM ".$Data['MhswID']."</title>";
			echo "<style>
			body {
				margin-left: 0 px;
			...
			PENUNJUKAN PEMBIMBING PENELITIAN<br />
			...
			<td width='77%' valign='top' style='text-align:Justify'>bahwa untuk kelancaran pelaksanaan penelitian bagi mahasiswa;</td>
			</tr>
			<tr>
			<td valign='top' style='padding-top:5px'>&nbsp;</td>
			<td valign='top' style='padding-top:5px'>&nbsp;</td>
			<td valign='top' style='padding-top:5px'>b.</td>
			<td valign='top' style='padding-top:5px; text-align:Justify'>bahwa untuk itu perlu menunjuk staf pengajar ".($Data['FID']=='08'? "Program":"Fakultas")." ".ucwords(strtolower($Data['Fakultas']))." ".ucwords(strtolower($NamaPT))." sebagai pembimbing;</td>
			</tr>
			<tr>
			<td valign='top' style='padding-top:5px'>&nbsp;</td>
			<td valign='top' style='padding-top:5px'>&nbsp;</td>
			<td valign='top' style='padding-top:5px'>c.</td>
			<td valign='top' style='padding-top:5px; text-align:Justify'>bahwa untuk itu perlu dikeluarkan Keputusan ".($Data['FID']=='08'? "Direktur Program":"Dekan Fakultas")." ".ucwords(strtolower($Data['Fakultas']))." ".ucwords(strtolower($NamaPT)).".</td>
			</tr>
			</table>
			<br /><br />
