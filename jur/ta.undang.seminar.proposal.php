	...
	$TAID = GetaField("ta", "MhswID", $MhswID, "TAID");
		if($ta = GetFields("ta", "TAID", $TAID, "*"))
		{
			...
			$Identitas		= GetFields('identitas',"Kode",KodeID,'*');
					...
					echo "<html>
					<head>
					<title>Undangan Seminar Proposal ".$Data['Nama']." (NPM ".$Data['MhswID'].")</title>
					<style>
					body {
						margin-left: 0 px;
					...
					<td valign='top'>: <b><i>Jadwal Seminar Proposal</i></b></td>
					<td>
					</td>
					<td width='43%' style='text-align:right'></td>
					</tr>
					...
					Dosen Pembimbing dan Penguji Ujian Seminar Proposal Program Studi $Data[Jurusan] ".($Data['FID']=='08'? "Program":"Fakultas")." $Data[Fakultas] ".$Identitas['Nama'].".
					<br>Di tempat
					</td>
					</tr>
					...
					<td colspan='4' style='text-align:Justify'>
					Dengan hormat,<br><br>
					Bersama ini kami mengundang Saudara untuk menghadiri Ujian Seminar Proposal pada :
					</td>
					</tr>
					...
					<td width='2%'>:</td>
					<td width='65%'>".GetaField('hari','HariID',date('w', strtotime($ta['TglUjianProposal'])),"Nama")." / ".TanggalFormat($ta['TglUjianProposal'])."</td>
					</tr>
					<tr>
					<td>Tempat</td>
					<td>:</td>
					...
					<td>Pukul</td>
					<td>:</td>
					<td>".substr($ta['JamUjianProposal'],0,5)."</td>
					</tr>
					...
					<tr>
					<td valign=top>Judul Proposal</td>
					<td valign=top>:</td>
					<td>".$ta['Judul']."</td>
					</tr>
