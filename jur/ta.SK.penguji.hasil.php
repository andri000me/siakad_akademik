	...
	include_once "../dwo.lib.php";
  	...
  	include_once "../cekparam.php";
		...
		if($ta = GetFields("ta", "NA='N' AND MhswID", $MhswID, "*"))
		{
			...
			echo "<html><head><title>SK Penunjukan Penguji Seminar Hasil ".($Data['FID']=='08'? "Tesis":"TA/Skripsi")." ".$Data['Nama']." - NPM ".$Data['MhswID']."</title>";
			echo "<style>
			body {
				margin-left: 0 px;
			...
			PENUNJUKAN PEMBIMBING TIM PENGUJI UJIAN SEMINAR HASIL<br />
			...
			<td width='77%' valign='top' style='text-align:Justify'>bahwa untuk pelaksanaan ujian seminar hasil Mahasiswa ".($Data['FID']=='08'? "Program":"Fakultas")." ".ucwords(strtolower($Data['Fakultas']))." ".ucwords(strtolower($NamaPT))." perlu ditunjuk tim penguji;</td>
			</tr>
			<tr>
			...
			<td valign='top'>:</td>
			<td valign='top' style='text-align:Justify'>Menunjuk dan menetapkan nama-nama dosen tim penguji ujian seminar hasil Program Studi ".$Data['Jurusan']." ".($Data['FID']=='08'? "Program":"Fakultas")." ".ucwords(strtolower($Data['Fakultas']))." ".ucwords(strtolower($NamaPT))." bagi mahasiswa:<br /></td>
			</tr>
			<tr>
			<td valign='top'>&nbsp;</td>
			<td valign='top'>&nbsp;</td>
			...
			<ol>
			<li>Melaksanakan ujian seminar hasil sesuai disiplin ilmu yang terkait.
			...
			<li>Membuat Berita Acara tentang ujian seminar hasil mahasiswa yang bersangkutan.
			</ol>
			</td>
			</tr>
