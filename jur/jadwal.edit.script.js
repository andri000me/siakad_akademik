...
function showRuang(ProdiID, frm, RuangID, HariID, Mulai_h, Mulai_n, Selesai_h, Selesai_n, tahun, NamaDiv) { 
  xmlHttp=GetXmlHttpObject()
  if (xmlHttp == null) {
    alert ("Browser does not support HTTP Request")
    return
  ...
  url = url + "&div=" + NamaDiv;
  url = url + "&TahunID=" + tahun;
  url = url + "&HariID=" + HariID;
  url = url + "&JamMulai=" + Mulai_h + ":" + Mulai_n;
  url = url + "&JamSelesai=" + Selesai_h + ":" + Selesai_n;
  url = url + "&sid=" + Math.random();
