...
//echo $ProdiID;
  $s = "select d.Login, d.Nama, d.Gelar1, d.Gelar, d.NA
    from dosen d
  ...
  while ($w = _fetch_array($r)) {
    ...
    if ($w['NA'] == 'Y') {
      ...
      $c = "class=ul";
      $d = "$_GET[doseni]<a href=\"javascript:$_SESSION[frm].DosenID$_SESSION[doseni].value='$w[Login]';$_SESSION[frm].Dosen$_SESSION[doseni].value='$w[Nama]';toggleBox('$_SESSION[div]', 0)\">
        &raquo; $w[Gelar1] 
        $w[Nama]</a>
        <sup>$w[Gelar]</sup>";
    }
