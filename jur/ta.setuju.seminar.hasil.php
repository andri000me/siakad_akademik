	...
	$MhswID = ($_SESSION['_LevelID']!='120' ? GetSetVar('MhswID'): $_SESSION['_Login']);
		if($ta = GetFields("ta", "MhswID", $MhswID, "*"))
		{
			...
			$Identitas		= GetFields('identitas',"Kode",KodeID,'*');
					...
					echo "<html>
					<head>
					<title>Tanda Persetujuan Seminar Hasil ".$Data['Nama']." (NPM ".$Data['MhswID'].")</title>
					<style>
					body {
						margin-left: 0 px;
					...
					<tr>
					<td colspan='4'><h3 align=center>TANDA PERSETUJUAN SEMINAR HASIL</td>
					</tr>";
					...
					<tr>
					<td colspan='4'>Kami yang bertanda tangan di bawah ini adalah Pembimbing Seminar Hasil dari :</td>
					</tr>
					...
					<tr>
					<td colspan='4' style='text-align:Justify'>Dengan ini menyatakan telah menyetujui hasil penelitian mahasiswa tersebut untuk diseminarkan pada ".($Data['FID']=='08'? "Program":"Fakultas")." ".$Data['Fakultas']." ".$Identitas['Nama'].".</td>
					</tr>
