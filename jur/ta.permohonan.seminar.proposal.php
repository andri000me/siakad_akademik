	...
	$Jabatan = GetSetVar('Jabatan');
		if($ta = GetFields("ta", "MhswID", $MhswID, "*"))
		{
			...
			$Identitas		= GetFields('identitas',"Kode",KodeID,'*');
					...
					echo "<html>
					<head>
					<title>Surat Permohonan Seminar Proposal ".$Data['Nama']." (NPM ".$Data['MhswID'].")</title>
					<style>
					body {
						margin-left: 0 px;
					...
					<td valign='top'>:</td>
					<td><b><i>Permohonan seminar proposal</i></b>
					</td>
					...
					<tr>
					<td colspan='4' style='text-align:Justify'>Dengan ini mengajukan permohonan untuk melaksanakan ujian seminar proposal :</td>
					</tr>
					...
					<table cellspacing='5' cellpadding='0' style='width:90%;'>
					<tr>
					<td width='35%' valign=top>Judul Proposal</td>
					...
					<tr>
					<td colspan='4' style='text-align:Justify'>Sebagai bahan pertimbangan penetapan Surat Keputusan (SK) pelaksanaan Seminar Proposal, saya lampirkan:
					<br>
					<ol>
					<li>Tanda persetujuan seminar dari pembimbing</li>
					<li>Foto kopi Lembar Hasil Studi (LHS) semester sebelumnya</li>
					<li>Foto kopi proposal 1 (satu) rangkap</li>
					</ol>
					</td>
					</tr>
